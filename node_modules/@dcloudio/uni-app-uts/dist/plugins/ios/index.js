...
function init() {
    ...
    return [
        ...
        (0, uni_cli_shared_1.resolveUTSCompiler)().uts2js({
            ...
            sharedDataLibName: isDom2 && !isDom2Dynamic ? utils_1.SHARED_DATA_LIB_NAME : undefined,
        ...
        ...(isDom2 && !isDom2Dynamic && (0, uni_cli_shared_1.isNormalCompileTarget)()
            ? [(0, plugin_2.uniAppXIOSEnginePlugin)()]
            : []),
    ];
}
exports.init = init;
